...
namespace TestGeckofx60
{
	...
	public static class MemoryManagement
	{
		...
		/// </summary>
		/// <param name="eventDescription">label for this memory check log output</param>
		...
		public static bool CheckMemory(string eventDescription, bool forceFullCollection = true)
		{
